...
test_that("get_info_chene_last_truffe works", {
  ...
  expect_equal(get_info_chene_last_truffe(dbtruffe, "123")$idoak, "123")
  expect_equal(get_info_chene_last_truffe(dbtruffe, "123")$date_found, as.Date("2023-03-15"))

  expect_equal(get_info_chene_last_truffe(dbtruffe, "123", filter_missing_info = TRUE)$date_found, as.Date("2023-01-01"))
