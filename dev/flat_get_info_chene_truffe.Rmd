...
```{r function-get_info_reensemence}
...
```{r example-get_info_reensemence}
conn <- connect_db()
...
test_that("get_info_reensemence works", {
  ...
  dbreensemence <- data.frame(idchene = c("theidchene", "otherid", "theidchene"), 
